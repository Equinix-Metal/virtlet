...
import (
	...
	"github.com/Equinix-Metal/virtlet/pkg/client/clientset/versioned/scheme"
...
func NewForConfig(c *rest.Config) (*VirtletV1Client, error) {
	...
	return &VirtletV1Client{client}, nil
}

// NewForConfigOrDie creates a new VirtletV1Client for the given config and
...
func New(c rest.Interface) *VirtletV1Client {
	return &VirtletV1Client{c}
}
