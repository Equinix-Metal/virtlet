...
* install the profiles located in [this directory](https://github.com/Equinix-Metal/virtlet/tree/master/deploy/apparmor) into the corresponding directory (`/etc/apparmor.d/` if you use Debian or its derivatives)
